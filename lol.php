...
{ 
    ...
    {   
            $query = "SELECT fpizzaname FROM bestelltepizza";
            $result = mysqli_query($this->_database, $query);
...
/*         foreach ($result as $name => $key) {
           ...
           array_push($array_bestellungen,$serializedData); 
